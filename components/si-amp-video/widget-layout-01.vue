<template>
  <article class="waf-amp article-detail">
    <div class="detail-wrapper">
      ...
      <div class="article-featured-media">
        ...
        <amp-youtube
          ...
          :data-videoid="getWidgetData.video_url"
          layout="responsive"
          width="480"
          height="270"
        ></amp-youtube>
        ...
        <amp-facebook
          ...
          data-allowfullscreen="set"
          data-align-center="true"
        ></amp-facebook>
      </div>
      <SiAdsWidgetLayout01 v-if="getAdData.adCode" :widget-data="getAdData" />
      <!-- <section id="32323-dd2323-wd3eewewe" data-component="si-ads" data-template="widget-layout-01">
        <amp-ad width="320" height="50" type="adform" data-width="300" data-height="250" data-bn="40004118">
          <div fallback>This Ad is not available for you.</div>
        </amp-ad>
      </section> -->
      <!-- <div class="content-wrap">
        <p>
          Lorem ipsum dolor sit amet, consectetur adipisicing elit. Saepe odio quisquam vel possimus a beatae, facere nemo numquam quibusdam illo,
          iste, laborum magnam architecto. Asperiores doloremque eius molestiae nobis debitis. Lorem ipsum dolor sit amet, consectetur adipisicing
          elit. Saepe odio quisquam vel possimus
        </p>
        <p>
          Lorem ipsum dolor sit amet, consectetur adipisicing elit. Saepe odio quisquam vel possimus a beatae, facere nemo numquam quibusdam illo,
          iste, laborum magnam architecto. Asperiores doloremque eius molestiae nobis debitis. Lorem ipsum dolor sit amet, consectetur adipisicing
...
export default {
  head() {
    try {
      ...
      this.winstonLogger.error({ location: "si-amp-video-widget-layout-01-headObj", name: e.name, message: e.message });
      return {};
    }
  },
  props: {
  ...
  computed: {
    ...
    getEntityPriorityData() {
      if (this.getWidgetData.entitydata) {
